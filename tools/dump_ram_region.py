#!/usr/bin/env python3
"""Dump bytes at physical address 0xF78D where the loop occurs."""
from pathlib import Path

data = Path(r'C:\Repository\C64_x86\build\guest-genxt.reu').read_bytes()

# Physical address 0xF78D -> file offset 0xF78D (since image starts at 0)
start_offset = 0xF780
end_offset = start_offset + 256

print(f"Physical address range: {start_offset:#07X} to {end_offset:#07X}")
print(f"File offsets: {start_offset:#06X} to {end_offset:#06X}\n")
