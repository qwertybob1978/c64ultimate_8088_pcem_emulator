...
SOURCES := src/boot/hwtest.s src/host/turbo.s src/host/keyboard.s src/cartridge/media_stage.s src/memory/reu.s \
	...
	src/cpu8088/interrupts.s src/cpu8088/multiply.s src/devices/pic.s \
	src/devices/pit.s src/devices/dma.s src/devices/fdc.s \
	src/memory/guest_memory.s src/memory/guest_init.s src/bus/io.s \
