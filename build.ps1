...
$objects = @(
    ...
    @{ Source = "src/cartridge/media_stage.s"; Object = "cartridge/media_stage.o" },
    ...
    @{ Source = "src/cpu8088/multiply.s"; Object = "cpu8088/multiply.o" },
    @{ Source = "src/devices/pic.s"; Object = "devices/pic.o" },
    @{ Source = "src/devices/pit.s"; Object = "devices/pit.o" },
    @{ Source = "src/devices/dma.s"; Object = "devices/dma.o" },
    @{ Source = "src/devices/fdc.s"; Object = "devices/fdc.o" },
    @{ Source = "src/bus/io.s"; Object = "bus/io.o" },
    @{ Source = "src/video/cga.s"; Object = "video/cga.o" },
    @{ Source = "src/memory/guest_memory.s"; Object = "memory/guest_memory.o" },
    @{ Source = "src/memory/guest_init.s"; Object = "memory/guest_init.o" },
